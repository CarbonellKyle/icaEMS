...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header  text-center p-3 lead">{{ __('Register') }}</div>
                ...
                <div class="card-body ml-4 ">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row ">
                            <label for="name" class="col-form-label ml-3 text-md-right">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-form-label ml-3 text-md-right">{{ __('E-Mail Address') }}</label>
